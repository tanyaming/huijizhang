...
public class Ip2RegionTest {
	...
	public static void main(String[] args) throws Exception {
		...
		File file= new File("D:\\workspace\\workspace-jinbooks-ee\\jinbooks\\jinbooks-starter\\jinbooks-starter-ip2location\\src\\main\\resources\\ip2region\\ip2region.xdb");
